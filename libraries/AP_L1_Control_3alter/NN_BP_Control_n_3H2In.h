...
public:                             //2-5-1      //explicit避免隐式转换
	...
	void set_weight(float wt1[2][7], float wt2[7][5],float wt3[5][5],float wt4[5][1]);
...
void Ann_bp::set_weight(float wt1[2][7], float wt2[7][5],float wt3[5][5],float wt4[5][1])
{
