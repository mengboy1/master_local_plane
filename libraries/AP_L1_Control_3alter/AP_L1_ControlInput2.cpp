...
#include "NN_BP_Control_n_3H2In.h"
...
//
//	// @Param: WT0_00
//	// @DisplayName: BPNN control weight gain
//	// @Description: BPNN control weight gain
//	// @Range: -40000.0 40000.0
//	// @Increment: 1
//	// @User: Advanced
//	AP_GROUPINFO("WT0_00",   4, AP_L1_Control, wt0_00, -0.0096f),
//
//	// @Param: WT0_01
//	// @DisplayName: BPNN control weight gain
//	// @Description: BPNN control weight gain
...
//	// @Increment: 1
//	// @User: Advanced
//	AP_GROUPINFO("WT0_01",   5, AP_L1_Control, wt0_01, -0.1198f),
//
//	// @Param: WT0_02
//	// @DisplayName: BPNN control weight gain
//	// @Description: BPNN control weight gain
...
//	// @Increment: 1
//	// @User: Advanced
//	AP_GROUPINFO("WT0_02",   6, AP_L1_Control, wt0_02, -1.9985f),
//
//	// @Param: WT0_03
//	// @DisplayName: BPNN control weight gain
//	// @Description: BPNN control weight gain
...
//	// @Increment: 1
//	// @User: Advanced
//	AP_GROUPINFO("WT0_03",   7, AP_L1_Control, wt0_03, 0.8350f),
//
//	// @Param: WT0_04
//	// @DisplayName: BPNN control weight gain
//	// @Description: BPNN control weight gain
...
//	// @Increment: 1
//	// @User: Advanced
//	AP_GROUPINFO("WT0_04",   8, AP_L1_Control, wt0_04, 0.1661f),
//
//	// @Param: WT0_10
//	// @DisplayName: BPNN control weight gain
//	// @Description: BPNN control weight gain
...
//	// @Increment: 1
//	// @User: Advanced
//	AP_GROUPINFO("WT0_10",   9, AP_L1_Control, wt0_10, -0.0102f),
//
//	// @Param: WT0_11
//	// @DisplayName: BPNN control weight gain
//	// @Description: BPNN control weight gain
...
//	// @Increment: 1
//	// @User: Advanced
//	AP_GROUPINFO("WT0_11",   10, AP_L1_Control, wt0_11, -0.0207f),
//
//	// @Param: WT0_12
//	// @DisplayName: BPNN control weight gain
//	// @Description: BPNN control weight gain
...
//	// @Increment: 1
//	// @User: Advanced
//	AP_GROUPINFO("WT0_12",   11, AP_L1_Control, wt0_12, 0.0220f),
//
//    // @Param: WT0_13
//	// @DisplayName: BPNN control weight gain
//	// @Description: BPNN control weight gain
...
//	// @Increment: 1
//	// @User: Advanced
//	AP_GROUPINFO("WT0_13",   12, AP_L1_Control, wt0_13, -0.0130f),
//
//	// @Param: WT0_14
//	// @DisplayName: BPNN control weight gain
//	// @Description: BPNN control weight gain
...
//	// @Increment: 1
//	// @User: Advanced
//	AP_GROUPINFO("WT0_14",   13, AP_L1_Control, wt0_14, -0.0089f),
//
////隐藏层到输出层权值
//
//	// @Param: WT1_00
//	// @DisplayName: BPNN control weight gain
//	// @Description: BPNN control weight gain
//	// @Range: -40000.0000 40000.0000
//	// @Increment: 0.0001
//	// @User: Advanced
//	AP_GROUPINFO("WT1_00",   14, AP_L1_Control, wt1_00, -0.3088),
//
//	// @Param: WT1_10
//	// @DisplayName: BPNN control weight gain
//	// @Description: BPNN control weight gain
...
//	// @Increment: 0.0001
//	// @User: Advanced
//	AP_GROUPINFO("WT1_10",   15, AP_L1_Control, wt1_10, -1.6900),
//
//	// @Param: WT1_20
//	// @DisplayName: BPNN control weight gain
//	// @Description: BPNN control weight gain
...
//	// @Increment: 0.0001
//	// @User: Advanced
//	AP_GROUPINFO("WT1_20",   16, AP_L1_Control, wt1_20, 1.4006),
//
//	// @Param: WT1_30
//	// @DisplayName: BPNN control weight gain
//	// @Description: BPNN control weight gain
...
//	// @Increment: 0.0001
//	// @User: Advanced
//	AP_GROUPINFO("WT1_30",   17, AP_L1_Control, wt1_30, 0.0160),
//
//	// @Param: WT1_40
//	// @DisplayName: BPNN control weight gain
//	// @Description: BPNN control weight gain
...
//	// @Increment: 0.0001
//	// @User: Advanced
//	AP_GROUPINFO("WT1_40",   18, AP_L1_Control, wt1_40, -0.3054),
//
////隐藏层偏置
//
//	// @Param: BS0_0
//	// @DisplayName: BPNN control bias gain
//	// @Description: BPNN control bias gain
//	// @Range: -40000.0000 40000.0000
//	// @Increment: 1
//	// @User: Advanced
//	AP_GROUPINFO("BS0_0",   19, AP_L1_Control, bs0_0, 0.0103f),
//
//	// @Param: BS0_1
//	// @DisplayName: BPNN control bias gain
//	// @Description: BPNN control bias gain
...
//	// @Increment: 1
//	// @User: Advanced
//	AP_GROUPINFO("BS0_1",   20, AP_L1_Control, bs0_1, -0.0131f),
//
//	// @Param: BS0_2
//	// @DisplayName: BPNN control bias gain
//	// @Description: BPNN control bias gain
...
//	// @Increment: 1
//	// @User: Advanced
//	AP_GROUPINFO("BS0_2",   21, AP_L1_Control, bs0_2, 1.8982f),
//
//	// @Param: BS0_3
//	// @DisplayName: BPNN control bias gain
//	// @Description: BPNN control bias gain
...
//	// @Increment: 1
//	// @User: Advanced
//	AP_GROUPINFO("BS0_3",   22, AP_L1_Control, bs0_3, -0.7967f),
//
//	// @Param: BS0_4
//	// @DisplayName: BPNN control bias gain
//	// @Description: BPNN control bias gain
...
//	// @Increment: 1
//	// @User: Advanced
//	AP_GROUPINFO("BS0_4",   23, AP_L1_Control, bs0_4, -0.1304f),
//
////输出层偏置
//
//	// @Param: BS1_0
...
//	// @Increment: 0.0001
//	// @User: Advanced
//	AP_GROUPINFO("BS1_0",   24, AP_L1_Control, bs1_0, -0.4018),
...
#define inNodes  2                 //输入层神经元数
#define hidNodes1 7                //隐藏层1
#define hidNodes2 5                //隐藏层2
...
void AP_L1_Control::update_waypoint(const struct Location &prev_WP, const struct Location &next_WP, float dist_min)
{
	...
	float e = _crosstrack_error - target;
	float de = e - e_pre;
	...
	//gcs().send_text(MAV_SEVERITY_INFO, "Tuning: e: %.4f,de: %.4f",(float)_crosstrack_error,(float)de);
...
//2-7-5-5-1-------------------------------------------------------------------------------------------------------
    ...
    float weights1[2][7] = {{-1.1853  , -0.3631 ,  0.3024 ,  0.9230  , -0.0149 , 0.3109  ,   0.6301},
                            {0.8725  , -0.5177 ,   -0.0181 ,   0.8925  ,  0.7883 ,  -0.7972  ,  0.2657}};
   
   float weights2[7][5] = {{-0.8613 ,  -0.4574 ,  0.7264 ,  -0.9885 ,1.0177},
							  {1.2110 ,  0.5498,   -0.7538 ,	 -0.2315 ,	-0.9977},
							  {0.3980  , 0.4201, -0.1364  , 0.1313	,0.2912},
							  {-0.0641  , -0.7037  ,  -0.1364  ,-0.3170	, 0.3287},
							  {0.6325  , 0.7052  ,  0.8287  ,	0.1414	,-0.0362},
							  {-0.3811,   -0.7485,   -0.5424,	  0.8331,	 0.6510},
							  {-0.6571 ,  -0.0997 ,   -0.6087 ,	 -1.1237 ,	0.6551}};

							
	float weights3[5][5] = {{0.3569,   -0.3237,   -0.9210,    0.2965,    1.5162},
                            {-0.3248,    1.0150,    0.5256,   -1.3813,   -0.6540},
                            {-0.6859,   -1.3496,    0.7666,   -0.3832,   -0.2527},
                            {0.3078,    0.8370,    1.0572,   -0.0214,    1.2854},
                            {0.8825,   -0.5784,    0.9468,   -0.5917,    1.1653}};
	
    float weights4[5][1] = {{-0.1160},
		                    {-0.5842}, 
		                    {-0.0282},
		                    {0.2961},
		                    {-0.1430}};

	float bias1[7] = { 1.6667,-1.2441, 0.5086,-0.1016,-0.5078,1.2633,1.8836};
	float bias2[5] = { 1.6282,1.0840, 0.0423,-0.7703,1.7689};
	float bias3[5] = { -2.0155,1.0300,-0.0253,1.0739,1.9241};
	float bias4[1] = { 0.3237};
	...
	gcs().send_text(MAV_SEVERITY_INFO, "Tuning: u1: %.4f",(float)u1 );
		...
		//write to log
	 AP::logger().Write("L1", "TimeUS,U,L1_Dis,e,de", "Qffff",
                                               AP_HAL::micros64(),
                                               (double)u1,
                                               (double)_L1_dist,
