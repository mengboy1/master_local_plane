...
/*void Plane::update_eight_plane()
{
    ...
    Vector3f rav =  eight_in_R2.center_loc.location_3d_diff_NED(eight_in_R2.aircraft_loc);
    ...
    case 0:
        ...
        //angle = 90 - angle;
        nav_controller->update_loiter_ellipse(eight_in_R2.center_loc, 3.0f * eight_in_R2.S1_radius_cm, 0.0f, eight_in_R2.azimuth_deg, eight_in_R2.orientation, eight_in_R2.aircraft_loc, eight_in_R2.aircraft_vel, eight_in_R2.desired_loc);
        break;
    case 1:
        // c1
...
void Plane::update_eight_plane()
{
    ...
    flower_in_R2.set_current_segment(flower_in_R2.aircraft_loc, flower_in_R2.aircraft_vel);

    Vector3f rav =  flower_in_R2.center_loc.location_3d_diff_NED(flower_in_R2.aircraft_loc);
    Vector3f _rxaplanev = rav - flower_in_R2.erxv * (flower_in_R2.erxv * rav);
    int8_t _current_quadrant;
    // north or south
    if (_rxaplanev * flower_in_R2.ethetaxv >= 0) {_current_quadrant = -2;} else {_current_quadrant = -1;}
    // east or west
    if (_rxaplanev * flower_in_R2.epsixv >= 0) {_current_quadrant = _current_quadrant + 2;} else {_current_quadrant = -_current_quadrant + 1;};
    ...
    case 0:
        // g1
        hal.console->println("segment 0: g1");
        //angle = atan2f(flower_in_R2.etg1v.y, flower_in_R2.etg1v.x) * RAD_TO_DEG_DOUBLE;
        //angle = 90 - angle;
        nav_controller->update_loiter_ellipse(flower_in_R2.center_loc, 3.0f * flower_in_R2.S1_radius_cm, 1.0f, flower_in_R2.azimuth_deg, flower_in_R2.orientation, flower_in_R2.aircraft_loc, flower_in_R2.aircraft_vel, flower_in_R2.desired_loc);
        break;
    case 1:
        // c1
        hal.console->println("segment 1: c1");
        nav_controller->update_loiter_ellipse(flower_in_R2.c1_loc, flower_in_R2.S1_radius_cm, 1.0f, flower_in_R2.azimuth_deg, flower_in_R2.orientation, flower_in_R2.aircraft_loc, flower_in_R2.aircraft_vel, flower_in_R2.desired_loc);
        break;
    case 2:
        // g2
        hal.console->println("segment 2: g2");
        //angle = atan2f(flower_in_R2.etg2v.y, flower_in_R2.etg2v.x) * RAD_TO_DEG_DOUBLE;
        // angle = 90 - angle;
        nav_controller->update_loiter_ellipse(flower_in_R2.center_loc, 3.0f * flower_in_R2.S1_radius_cm, 1.0f, flower_in_R2.azimuth_deg, flower_in_R2.orientation, flower_in_R2.aircraft_loc, flower_in_R2.aircraft_vel, flower_in_R2.desired_loc);
        break;
    case 3:
        // c2
        hal.console->println("segment 3: c2");
        nav_controller->update_loiter_ellipse(flower_in_R2.c2_loc, flower_in_R2.S1_radius_cm, 1.0f, flower_in_R2.azimuth_deg, -flower_in_R2.orientation, flower_in_R2.aircraft_loc, flower_in_R2.aircraft_vel, flower_in_R2.desired_loc);
        break;
    }
...
//     hal.console->println(eight_sphere.segment);
     //hal.console->printf("desired_loc: ",S1_in_S2.desired_loc.lat,", ",S1_in_S2.desired_loc.lng,", ",S1_in_S2.desired_loc.alt);
...
//        hal.console->println(micros());
//            Vector3f adiff = eight_in_S2.S2_loc.location_3d_diff_NED(eight_in_S2.aircraft_loc);
//            Vector3f desdiff = eight_in_S2.S2_loc.location_3d_diff_NED(eight_in_S2.desired_loc);
        //hal.console->printf("height, desired height: ",adiff.z,", ",desdiff.z);
...
//    hal.console->println(S1avec.z);
    ...
    struct Location aloc = eight_in_S2.aircraft_loc;
     Vector3f rav = eight_in_S2.S2_loc.location_3d_diff_NED(aloc);
...
//      }
		...
		//hal.console->println("entered new quadrant: ") { printf("%s\r\n", _current_quadrant);} 
			...
			//hal.console->println("new quadrant is next quadrant?") { printf("%s\r\n", eight_in_S2.entered_next_quadrant);} 
