...
/*void Plane::do_eight_plane()
{
   ...
   // eight_in_R2.center_loc = prev_WP_loc; // location of the center point on the ground
  ...
  eight_in_R2.ethetaxv = Vector3f(eight_in_R2.cos_psi, eight_in_R2.sin_psi, 0);
   //eight_in_R2.ethetaxv = Vector3f(-eight_in_R2.sin_psi, eight_in_R2.cos_psi, 0);
  ...
  //eight_in_R2.epsixv = Vector3f(eight_in_R2.cos_psi, eight_in_R2.sin_psi, 0);
...
void Plane::do_eight_plane()
{
    flower_in_R2.center_loc = home; // location of the center point on the ground
   // eight_in_R2.center_loc = prev_WP_loc; // location of the center point on the ground
    flower_in_R2.d_c_cm = 20000; // horizontal distance from crossing point to turning point
    flower_in_R2.S1_radius_cm = 10000; // radius of the turning circles
    flower_in_R2.height_cm = 10000; // height of the pattern above the center point
    flower_in_R2.azimuth_deg = 0.0f;
    flower_in_R2.orientation = 1;     // orientation of the figure-eight pattern

    // the four segments are labeled by integers 0,1,2,3 in dependence of orientation
    // for orientation of the flower-eight pattern: +1: segment sequence is: circle_1 -> circle_4 -> circle_3 -> circle_2
    //                                              -1: segment sequence is: circle_1 -> circle_2 -> circle_3 -> circle_4

    // set current quadrant to a value that is not 0,1,2,3 such that it is altered in the initialization
    flower_in_R2.current_quadrant = 4;
    flower_in_R2.current_segment = 0; // sets the start segment when eight_sphere is initialized
                                     // and the entry segment if no segment switching occurs because the aircraft is located in the vicinity of the crossing point defined by _mindistxaplane

  // derived parameters
  // trigonometric functions of all angles
  // trigonometric functions of the angles determining the attitude (azimuthal position in the sky) of the figure-eight pattern
  flower_in_R2.cos_psi = cosf(radians(flower_in_R2.azimuth_deg));
  flower_in_R2.sin_psi = sinf(radians(flower_in_R2.azimuth_deg));
  // trigonometric functions of half of the crossing angle
  flower_in_R2.sin_chihalf = (flower_in_R2.S1_radius_cm / 100.0f) / (flower_in_R2.d_c_cm / 100.0f);
  flower_in_R2.cos_chihalf = sqrt(1 - sq(flower_in_R2.sin_chihalf));

  // crossing point of the figure-eight pattern: coordinate frame, rotation matrix, position vector
  // unit vector pointing from S2_loc to the crossing point of the figure-eight pattern
  flower_in_R2.erxv = Vector3f(0, 0, -1);
  // unit vector of the tangential plane at the crossing point in polar direction
  flower_in_R2.ethetaxv = Vector3f(flower_in_R2.cos_psi, flower_in_R2.sin_psi, 0);
   //eight_in_R2.ethetaxv = Vector3f(-eight_in_R2.sin_psi, eight_in_R2.cos_psi, 0);
  
  // unit vector of the tangential plane at the crossing point in azimuthal direction
  flower_in_R2.epsixv = Vector3f(-flower_in_R2.sin_psi, flower_in_R2.cos_psi, 0);
  //eight_in_R2.epsixv = Vector3f(eight_in_R2.cos_psi, eight_in_R2.sin_psi, 0);

  
  // rotation matrix that yields the vectors of the figure_eight pattern with crossing point in the direction erxv
  // from those of the figure-eight pattern with crossing point at erv; // = (0,0,-1) and turning circle centers aligned with the east axis
  flower_in_R2.Rm = Matrix3f(flower_in_R2.ethetaxv, flower_in_R2.epsixv, -flower_in_R2.erxv);
  // vector pointing from S2_loc to the crossing point
  flower_in_R2.rxv = flower_in_R2.erxv * flower_in_R2.height_cm / 100.0f;
  ...
  // vector of the first turning circle center
  // orientation of c1 = orientation
  flower_in_R2.rc1v = (flower_in_R2.Rm * Vector3f(0.0f, flower_in_R2.d_c_cm/100.0f, -flower_in_R2.height_cm/100.0f));
  // vector of the second turning circle center
  // orientation of c2 = - orientation
  flower_in_R2.rc2v = (flower_in_R2.Rm * Vector3f(0.0f, -flower_in_R2.d_c_cm/100.0f, -flower_in_R2.height_cm/100.0f));

  flower_in_R2.c1_loc = home;
  flower_in_R2.c1_loc.offset(flower_in_R2.rc1v.x, flower_in_R2.rc1v.y);
  flower_in_R2.c1_loc.alt = flower_in_R2.c1_loc.alt + flower_in_R2.height_cm/100.0f;
  flower_in_R2.c2_loc = home;
  flower_in_R2.c2_loc.offset(flower_in_R2.rc2v.x, flower_in_R2.rc2v.y);
  flower_in_R2.c2_loc.alt = flower_in_R2.c2_loc.alt + flower_in_R2.height_cm/100.0f;



  // vectors from the center of the plane to the eastern transition points
  // NE
  flower_in_R2.rtg1c1 = (flower_in_R2.Rm * (flower_in_R2.rc1v + Vector3f(flower_in_R2.S1_radius_cm/100.0f * flower_in_R2.cos_chihalf, -flower_in_R2.S1_radius_cm/100.0f * flower_in_R2.sin_chihalf, 0.0f)));
  // SE
  flower_in_R2.rtc1g2 = (flower_in_R2.Rm * (flower_in_R2.rc1v + Vector3f(-flower_in_R2.S1_radius_cm/100.0f * flower_in_R2.cos_chihalf, -flower_in_R2.S1_radius_cm/100.0f * flower_in_R2.sin_chihalf, 0.0f)));


  // locations of the transition points
  // NE
  flower_in_R2.g1c1_loc = flower_in_R2.center_loc;
  flower_in_R2.g1c1_loc.offset(flower_in_R2.rtg1c1.x, flower_in_R2.rtg1c1.y);
  flower_in_R2.g1c1_loc.alt = flower_in_R2.g1c1_loc.alt - flower_in_R2.height_cm/100.0f;
  // SE
  flower_in_R2.c1g2_loc = flower_in_R2.center_loc;
  flower_in_R2.c1g2_loc.offset(flower_in_R2.rtc1g2.x, flower_in_R2.rtc1g2.y);
  flower_in_R2.c1g2_loc.alt = flower_in_R2.c1g2_loc.alt - flower_in_R2.height_cm/100.0f;
  // SW
  flower_in_R2.c2g1_loc = flower_in_R2.center_loc;
  flower_in_R2.c2g1_loc.offset(-flower_in_R2.rtg1c1.x, -flower_in_R2.rtg1c1.y);
  flower_in_R2.g1c1_loc.alt = flower_in_R2.g1c1_loc.alt - flower_in_R2.height_cm/100.0f;
  // NW
  flower_in_R2.g2c2_loc = flower_in_R2.center_loc;
  flower_in_R2.g2c2_loc.offset(-flower_in_R2.rtc1g2.x, -flower_in_R2.rtc1g2.y);
  flower_in_R2.g2c2_loc.alt = flower_in_R2.g2c2_loc.alt - flower_in_R2.height_cm/100.0f;


  // unit tangent vectors of the two geodesic segments
  flower_in_R2.etg1v = flower_in_R2.Rm * Vector3f(flower_in_R2.sin_chihalf, flower_in_R2.cos_chihalf, 0.0f) * flower_in_R2.orientation;
  flower_in_R2.etg2v = flower_in_R2.Rm * Vector3f(flower_in_R2.sin_chihalf, -flower_in_R2.cos_chihalf, 0.0f) * flower_in_R2.orientation;

  // tangent vectors at the transgression points between the segments in the directions demanded by orientation
  // in NE quadrant:
  flower_in_R2.etg1c1v = flower_in_R2.etg1v;
  // in SE quadrant:
  flower_in_R2.etc1g2v = flower_in_R2.etg2v;
  // in NW quadrant
  flower_in_R2.etg2c2v = flower_in_R2.etg2v;
  // in SW quadrant
  flower_in_R2.etc2g1v = flower_in_R2.etg1v;

  // array of turning circle center vectors labeled by the quadrant number
  flower_in_R2.centervectors[0] = flower_in_R2.rc1v;
  flower_in_R2.centervectors[1] = flower_in_R2.rc1v;
  flower_in_R2.centervectors[2] = flower_in_R2.rc2v;
  flower_in_R2.centervectors[3] = flower_in_R2.rc2v;
  // array of unit tangent vectors at the transgression points of the segments labeled by the quadrant number
  flower_in_R2.tangentvectors[0] =  flower_in_R2.etg1c1v;
  flower_in_R2.tangentvectors[1] =  flower_in_R2.etc1g2v;
  flower_in_R2.tangentvectors[2] =  flower_in_R2.etc2g1v;
  flower_in_R2.tangentvectors[3] =  flower_in_R2.etg2c2v;
